$(document).ready(function() {
  var $herbStock = $("#herbStock"),
    ...
    formula = new Array(),
    add_icon =
      "<a href='' title='Add this to your formula!' class='ui-icon ui-icon-plus'>Add this!</a>",
    remove_icon =
      "<a href='' title='Remove this Herb' class='ui-icon  ui-icon-minus'>Remove Herb</a>";
  ...
  // Array of formulas
  formula[0] = new DecocStruc(
    "Sang Ju Yin",
    "Sang Ye, Ju Hua, Lian Qiao, Bo He, Jie Geng, Xing Ren, Lu Gen, Gan Cao"
  );
  formula[1] = new DecocStruc(
    "Yin Qiao San",
    "Jin Yin Hua, Lian Qiao, Jie Geng, Nui Bang Zi, Bo He, Don Dou Chi, Jing Jie, Dan Zhu Ye, Lu Gen, Gan Cao"
  );
  formula[2] = new DecocStruc(
    "Bai Hu Tang",
    "Shi Gao, Zhi Mu, Geng Mi, Gan Cao"
  );
  formula[3] = new DecocStruc(
    "Ma Huang Tang",
    "Ma Huang, Gui Zhi, Xing Ren, Gan Cao"
  );
  formula[4] = new DecocStruc(
    "Gui Zhi Tang",
    "Gui Zhi, Bai Shao, Sheng Jiang, Da Zao, Gan Cao"
  );
  formula[5] = new DecocStruc(
    "Si Jun Zi Tang",
    "Ren Shen, Bai Zhu, Fu Ling, Gan Cao"
  );
  formula[6] = new DecocStruc(
    "Si Wu Tang",
  ...
  formula[8] = new DecocStruc(
    "Si Ni San",
    "Chai Hu, Zhi Shi, Bai Shao, Gan Cao"
  );
  formula[9] = new DecocStruc(
    "Liu Wei Di Huang Wan",
    "Shu Di Huang, Shan Zhu Yu, Shan Yao, Fu Ling, Mu Dan Pi, Ze Xie"
  );
  formula[10] = new DecocStruc(
    "Li Zhong Tang",
    "Gan Jiang, Ren Shen, Bai Zhu, Gan Cao"
  );
  formula[11] = new DecocStruc(
    "Da Cheng Qi Tang",
    "Da Huang, Mang Xiao, Zhi Shi, Huo Po"
  );
  formula[12] = new DecocStruc(
    "Huang Lian Jie Du Tang",
    "Huang Lian, Huang Qin, Huang Bai, Zhi Zi"
  );
  formula[13] = new DecocStruc(
    "Sheng Mai San",
    "Ren Shen, Wu Wei Zi, Mai Men Dong"
  );
  formula[14] = new DecocStruc(
    "Dao Chi San",
  ...
  formula[20] = new DecocStruc(
    "Liu Jun Zi Tang",
    "Ren Shen, Bai Zhu, Fu Ling, Gan Cao, Ban Xia, Chen Pi"
  );
  formula[21] = new DecocStruc(
    "Xiang Sha Liu Jun Zi Tang",
    "Ren Shen, Bai Zhu, Fu Ling, Gan Cao, Ban Xia, Chen Pi, Mu Xiang, Sha Ren"
  );
  formula[22] = new DecocStruc(
    "Bu Zhong Yi Qi Tang",
    "Huang Qi, Ren Shen, Bai Zhu, Gan Cao, Dang Gui, Chen Pi, Sheng Ma, Chai Hu"
  );
  formula[23] = new DecocStruc(
    "Sheng Ling Bai Zhu San",
    "Ren Shen, Bai Zhu, Fu Ling, Gan Cao, Shan Yao, Bai Bian Duo, Lian Zi, Yi Yi Ren, Sha Ren, Jie Geng"
  );

  formula[24] = new DecocStruc(
    "Gui Pi Tang",
    "Ren Shen, Huang Qi, Bai Zhu, Fu Ling, Suan Zao Ren, Long Yan Rou, Mu Xiang, Sheng Jiang, Da Zao, Gan Cao, Dang Gui, Yuan Zhi"
  );
  formula[25] = new DecocStruc(
    "Ren Shen Bai Du San",
    "Qiang Huo, Du Huo, Chuan Xiong, Chai Hu, Bo He, Jie Geng, Zhi Ke, Qian Hu, Ren Shen, Fu Ling, Gan Cao, Sheng Jiang"
  );
  formula[26] = new DecocStruc(
    "Ba Zhen Tang",
    "Ren Shen, Fu Ling, Bai Zhu, Gan Cao, Shu Di Huang, Bai Shao, Dang Gui, Chuan Xiong"
  );
  formula[27] = new DecocStruc(
    "Shi Quan Da Bu Tang",
    "Ren Shen, Bai Zhu, Fu Ling, Gan Cao, Shu Di Huang, Bai Shao, Dang Gui, Chuan Xiong, Rou Gui, Huang Qi"
  );
  formula[28] = new DecocStruc(
    "Du Huo Ji Sheng Wan",
    "Du Huo, Xi Xin, Fang Feng, Qin Jiao, Sang Ji Sheng, Du Zhong, Niu Xi, Rou Gui"
  );
  formula[29] = new DecocStruc(
    "Xue Fu Zhu Yu Tang",
    "Tao Ren, Hong Hua, Chuan Xiong, Chi Shao, Dang Gui, Sheng Di Huang, Chuan Niu Xi, Chai Hu, Jie Geng, Zhi Ke, Gan Cao"
  );
  formula[30] = new DecocStruc(
    "Ban Xia Bai Zhu Tian Ma Tang",
    "Ban Xia, Tian Ma, Bai Zhu, Fu Ling, Chen Pi, Gan Cao, Sheng Jiang, Da Zao"
  );
  formula[31] = new DecocStruc(
    "Chai Hu Shu Gan San",
    "Chen Pi, Chuan Xiong, Bai Shao, Xiang Fu, Chai Hu, Zhi Ke, Gan Cao"
  );

  formula[32] = new DecocStruc(
    "Xing Su San",
    "Zi Su Ye, Xing Ren, Qian Hu, Jie Geng, Zhi Ke, Chen Pi, Fu Ling, Ban Xia, Sheng Jiang, Da Zao, Gan Cao"
  );
  formula[33] = new DecocStruc(
    "Wen Dan Tang",
    "Ban Xia, Zhu Ru, Zhi Shi, Chen Pi, Fu Ling, Gan Cao, Sheng Jiang, Da Zao"
  );
  formula[34] = new DecocStruc(
    "Huo Xiang Zheng Qi San",
    "Huo Xiang, Huo Po, Chen Pi, Zi Su Ye, Bai Zhi, Ban Xia, Da Fu Pi, Bai Zhu, Fu Ling, Jie Geng, Gan Cao, Sheng Jiang, Da Zao"
  );
  formula[35] = new DecocStruc(
    "Bao He Wan",
    "Shan Zha, Shen Qu, Lai Fu Zi, Chen Pi, Ban Xia, Fu Ling, Lian Qiao"
  );
  formula[36] = new DecocStruc(
    "Xiao Yao San",
    "Chai Hu, Dang Gui, Bai Shao, Bai Zhu, Fu Ling, Gan Cao, Wei Jiang, Bo He"
  );
  formula[37] = new DecocStruc(
    "Ping Wei San",
    "Cang Zhu, Huo Po, Chen Pi, Gan Cao, Sheng Jiang, Da Zao"
  );
  formula[38] = new DecocStruc(
    "Bei Mu Gua Lou San",
    "Bei Mu, Gua Lou, Tian Hua Fen, Fu Ling, Ju Hong, Jie Geng"
  );
  formula[39] = new DecocStruc(
    "Ban Xia Huo Po Tang",
    "Ban Xia, Huo Po, Fu Ling, Sheng Jiang, Zi Su Ye"
  );

  formula[40] = new DecocStruc(
    "Jin Gui Shen Qi Wan",
    "Shu Di Huang, Shan Zhu Yu, Shan Yao, Fu Ling, Mu Dan Pi, Ze Xie, Fu Zi, Gui Zhi"
  );
  formula[41] = new DecocStruc(
    "Zhi Bai Di Huang Wan",
    "Zhi Mu, Huang Bai, Shu Di Huang, Shan Zhu Yu, Shan Yao, Fu Ling, Mu Dan Pi, Ze Xie"
  );
  formula[42] = new DecocStruc(
    "Qi Ju Di Huang Wan",
    "Gou Qi Zi, Ju Hua, Shu Di Huang, Shan Zhu Yu, Shan Yao, Fu Ling, Mu Dan Pi, Ze Xie"
  );
  formula[43] = new DecocStruc(
    "Yi Guan Jian",
    "Sheng Di Huang, Gou Qi Zi, Sha Shen, Mai Men Dong, Dang Gui, Chuan Lian Zi"
  );
  formula[44] = new DecocStruc(
    "Tian Wang Bu Xin Dan",
    "Sheng Di Huang, Tian Men Dong, Mai Men Dong, Xuan Shen, Dan Shen, Dang Gui, Bai Zi Ren, Yuan Zhi, Ren Shen, Fu Ling, Suan Zao Ren, Wu Wei Zi, Jie Geng, Zhu Sha"
  );
  formula[45] = new DecocStruc(
    "Qing Hao Bie Jia Tang",
    "Bie Jia, Qing Hao, Sheng Di Huang, Zhi Mu, Mu Dan Pi"
  );
  formula[46] = new DecocStruc(
    "Gu jing Wan",
    "Gui Ban, Bai Shao, Huang Qin, Chun Pi, Huang Bai, Xiang Fu"
  );
  formula[47] = new DecocStruc(
    "Gan Mai Da Zao Tang",
    "Gan Cao, Fu Xiao Mai, Da Zao"
  );

  formula[48] = new DecocStruc(
    "Ge Gen Tang",
    "Ge Gen, Ma Huang, Gui Zhi, Bai Shao, Sheng Jiang, Da Zao, Gan Cao"
  );
  formula[49] = new DecocStruc(
    "Chai Ge Jie Ji Tang",
    "Chai Hu, Ge Gen, Qiang Huo, Bai Zhi, Huang Qin, Shi Gao, Jie Geng, Bai Shao, Gan Cao, Sheng Jiang, Da Zao"
  );
  formula[50] = new DecocStruc(
    "Ma Xing Shi Gan Tang",
    "Ma Huang, Shi Gao, Xing Ren, Gan Cao"
  );
  formula[51] = new DecocStruc(
    "Xiao Cheng Qi Tang",
    "Da Huang, Huo Po, Zhi Shi"
  );
  formula[52] = new DecocStruc(
    "Tiao Wei Cheng Qi Tang",
    "Da Huang, Gan Cao, Mang Xiao"
  );
  formula[53] = new DecocStruc(
    "Ban Xia Xie Xin Tang",
    "Ban Xia, Gan Jiang, Huang Qin, Huang Lian, Ren Shen, Da Zao, Gan Cao"
  );
  formula[54] = new DecocStruc(
    "Wu Zhu Yu Tang",
    "Wu Zhu Yu, Sheng Jiang, Ren Shen, Da Zao"
  );
  formula[55] = new DecocStruc(
    "Da Jian Zhong Tang",
    "Hua Jiao, Gan Jiang, Ren Shen, Yi Tang"
  );
  formula[56] = new DecocStruc(
    "Xiao Jian Zhong Tang",
    "Gui Zhi, Bai Shao, Sheng Jiang, Da Zao, Gan Cao, Yi Tang"
  );
  ...
  function RollFormula(numSet) {
    ...
    //Change the heading
    $("#formula h4").html(
      formula[formulaID].name +
        " (" +
        formula[formulaID].ingredients.split(", ").length +
        ")"
    );
  ...
  $formula.droppable({
    ...
    drop: function(event, ui) {
      ...
      if (
        compareHerbs(ui.draggable.children().attr("title"), formulaID) == true
      ) {
